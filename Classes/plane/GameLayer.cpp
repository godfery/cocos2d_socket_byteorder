...
bool GameLayer::init()
{
    ...
    listener1->onTouchMoved = CC_CALLBACK_2(GameLayer::onTouchMoved, this);

    listener1->onTouchEnded = CC_CALLBACK_2(GameLayer::onTouchEnded, this);
...
void GameLayer::onTouchMoved(Touch* pTouch, Event* event)
{
