...
bool ControlLayer::init()
{
	...
	do 
	{
		...
		//加入PauseMenu
		Sprite* normalPause=Sprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("game_pause_nor.png"));
		Sprite* pressedPause=Sprite::createWithSpriteFrame(CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName("game_pause_pressed.png"));
		pPauseItem=MenuItemImage::create();
//		pPauseItem->initWithNormalSprite(normalPause,pressedPause,NULL,this,menu_selector(ControlLayer::menuPauseCallback));
		//pPauseItem->initWithNormalSprite(normalPause,pressedPause,NULL,this,CC_CALLBACK_1(ControlLayer::menuPauseCallback, this));
		//pPauseItem = MenuItemImage::create(normalPause,pressedPause,normalPause,  CC_CALLBACK_1(ControlLayer::menuPauseCallback, this));
		pPauseItem->setNormalImage(normalPause);
		pPauseItem->setSelectedImage(pressedPause);
		pPauseItem->setCallback(CC_CALLBACK_1(ControlLayer::menuPauseCallback, this));
